    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            table = $('#demo-datatables').DataTable({
                ...
                ajax: {
                    "url": '<?php echo e(URL('karyawan/json')); ?>',
                    "type": "POST",
                    "headers": {
            ...
            table.on('click', '.btn-edit', function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(URL('karyawan/getKaryawan')); ?>",
                    type: "GET",
                    data: "id=" + id,
                    dataType: 'json',
            ...
            $("#btn-insert-data").click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('karyawan/insert')); ?>",
                    type: "POST",
                    data: sendData,
                    dataType: 'json',
                    beforeSend: function () {
            ...
            $("#btn-update-data").click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('karyawan/update')); ?>",
                    type: "PUT",
                    data: sendData,
                    dataType: 'json',
                    beforeSend: function () {
                        ...
                        ok: {
                            ...
                            action: function () {
                                $.ajax({
                                    ...
                                    url: "<?php echo e(URL('karyawan/delete')); ?>",
                                    type: "DELETE",
                                    data: "id=" + id,
                                    dataType: "json",
                                    success: function (data) {
            ...
            $("#no_hp, #upd_no_hp").keyup(function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('user/cekNoHp')); ?>",
                    type: "GET",
                    data: "noHp=" + noHp,
                    dataType: "json",
                    success: function (data) {
