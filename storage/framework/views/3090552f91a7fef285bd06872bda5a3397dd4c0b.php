                                ...
                                <div class="demo-form-wrapper">
                                    <form class="form form-horizontal" id="frm-website" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <input id="nama_perusahaan" autocomplete="off" maxlength="50" name="nama_perusahaan" value="<?php echo e($konfig[4]->nilai_konfig); ?>" class="form-control" type="text" placeholder="Nama Perusahaan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <input id="nama_pemilik" autocomplete="off" maxlength="50" name="nama_pemilik" value="<?php echo e($konfig[6]->nilai_konfig); ?>" class="form-control" type="text" placeholder="Pemilik Perusahaan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <input id="email" autocomplete="off" maxlength="60" name="email" value="<?php echo e($konfig[1]->nilai_konfig); ?>" class="form-control" type="email" placeholder="Email Perusahaan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <input id="no_hp" autocomplete="off" name="no_hp" value="<?php echo e($konfig[5]->nilai_konfig); ?>" maxlength="12" class="form-control" type="text" placeholder="Nomor Telepon Perusahaan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <input id="harga" autocomplete="off" name="harga" value="<?php echo e(number_format($konfig[2]->nilai_konfig, 0, ".", ".")); ?>" maxlength="12" class="form-control" type="text" placeholder="Nomor Telepon Perusahaan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <input id="versi" autocomplete="off" name="versi" value="<?php echo e($konfig[8]->nilai_konfig); ?>" maxlength="12" class="form-control" type="text" placeholder="Nomor Telepon Perusahaan">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <div class="input-group">
                                                        <input class="form-control form-password" id="password" value="<?php echo e($konfig[7]->nilai_konfig); ?>" name="password" maxlength="12" minlength="8" type="password" placeholder="Password">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-with-icon">
                                                    <textarea id="alamat" name="alamat" class="form-control" maxlength="700" rows="3" placeholder="Alamat Perusahaan"><?php echo e($konfig[0]->nilai_konfig); ?></textarea>
                ...
                <div class="col-md-6">
                    <div class="panel m-b-lg">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="home-11">
                                <div class="col-md-12">
                                    <?php if($konfig[3]->nilai_konfig == 'logo2.png'): ?>
                                        <img class="img-responsive center-block" src="<?php echo e(Avatar::create("Failda Waterpark")->toBase64()); ?>" width="128px" height="128px" style="margin-bottom: 5%" alt="Failda">
                                    <?php else: ?>
                                        <img class="img-responsive center-block" src="<?php echo e(asset('storage/' . $konfig[3]->nilai_konfig)); ?>" width="70%" style="margin-bottom: 5%" alt="Failda">
                                    <?php endif; ?>
                                </div>
                                <div class="card-body">
                                    <h3 class="card-title text-center"><?php echo e($konfig[4]->nilai_konfig); ?></h3>
                                    <p class="card-text text-center">
                                        <small><?php echo e($konfig[0]->nilai_konfig); ?></small>
                                    </p>
                                    <table class="table table-striped">
                                        <tr>
                                            <td>Nama Pemilik</td>
                                            <td width="1px">:</td>
                                            <td><?php echo e($konfig[5]->nilai_konfig); ?></td>
                                        </tr>
                                        <tr>
                                            <td>No Telepon</td>
                                            <td width="1px">:</td>
                                            <td><?php echo e($konfig[4]->nilai_konfig); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                            <td width="1px">:</td>
                                            <td><?php echo e($konfig[1]->nilai_konfig); ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
        ...
        $(document).ready(function () {
            ...
            $("#frm-website").submit(function (event) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: "<?php echo e(URL('konfigurasi/update')); ?>",
                    data: formData,
