<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card bg-primary no-border">
                        <div class="card-values">
                            <div class="p-x">
                                ...
                                <h3 class="card-title fw-l"><?php echo e($hari); ?></h3>
                            </div>
                        </div>
                    ...
                    <div class="card bg-danger no-border">
                        <div class="card-values">
                            <div class="p-x">
                                ...
                                <h3 class="card-title fw-l">Rp. <?php echo e(number_format($totalUang, 0 , ".", ".")); ?></h3>
                            </div>
                        </div>
                        <div class="card-chart">
                    ...
                    <div class="card bg-info no-border">
                        <div class="card-values">
                            <div class="p-x">
                                ...
                                <h3 class="card-title fw-l"><?php echo e($hari2); ?></h3>
                            </div>
                        </div>
                        <div class="card-chart">
                    ...
                    <div class="card bg-warning no-border">
                        <div class="card-values">
                            <div class="p-x">
                                ...
                                <h3 class="card-title fw-l">Rp. <?php echo e(number_format($totalUangFromMobile, 0 , ".", ".")); ?></h3>
                            </div>
                        </div>
                        <div class="card-chart">
    ...
    <script>
        $(document).ready(function () {
            var url = "<?php echo e(URL('dashboard/chart')); ?>";
            var jumlah = [];
            var url1 = "<?php echo e(URL('dashboard/chart1')); ?>";
            var jumlah1 = [];
            var bulan = [];
            var tanggal = [];
