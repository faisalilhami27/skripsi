        ...
        <div class="navbar-header">
            ...
            <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse"
                ...
                <span class="ellipsis ellipsis-vertical">
                    <?php if(is_null(Session::get('images'))): ?>
                        <img class="ellipsis-object" width="32" height="32"
                             src="<?php echo e(Avatar::create(Session::get('nama_lengkap'))->toBase64()); ?>"
                             alt="Profile">
                    <?php else: ?>
                        <img class="ellipsis-object" width="32" height="32"
                             src="<?php echo e(asset('storage/'. Session::get('images'))); ?>"
                             alt="Teddy Wilson">
                    <?php endif; ?>
            </span>
            </button>
            ...
            <nav id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="visible-xs-block">
                        <h4 class="navbar-text text-center">Hi, <?php echo e(Session::get('nama_lengkap')); ?></h4>
                    </li>
                    ...
                    <li class="dropdown hidden-xs">
                        <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                            <?php if(is_null(Session::get('images'))): ?>
                                <img class="circle" width="36" height="36"
                                     src="<?php echo e(Avatar::create(Session::get('nama_lengkap'))->toBase64()); ?>"
                                     alt="test"> <?php echo e(Session::get('nama_lengkap')); ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li class="navbar-upgrade-version"> Version <?php echo e(versionApp()); ?></li>
                            <li class="divider"></li>
                            <?php if(Session::get('count') > 1): ?>
                                <li><a href="<?php echo e(URL('role')); ?>">Pilih Hak Akses</a></li>
                ...
                <div class="title-bar">
                    <h1 class="title-bar-title">
                        <span class="d-ib"><?php echo e($title); ?></span>
                        <span class="d-ib">
                </span>
                    </h1>
                    <p class="title-bar-description">
                        <small><?php echo e($deskripsi); ?></small>
                    </p>
                </div>
            </nav>
        </div>
