                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="upd_status" name="main_menu" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m->id); ?>"><?php echo e($m->nama_status); ?></option>
    ...
    $(document).ready(function () {
        ...
        $('#kode').typeahead({
            ...
            source: function (query, result) {
                ...
                return $.ajax({
                    ...
                    url: '<?php echo e(URL('konfirmasi/getKodePemesanan')); ?>',
                    type: 'GET',
        ...
        table.on('click', '.btn-edit', function (e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(URL('konfirmasi/getKonfirmasiById')); ?>",
                type: "GET",
                data: "id=" + id,
                dataType: 'json',
                success: function (data) {
        ...
        table.on('click', '.btn-link', function (e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(URL('konfirmasi/getBuktiPembayaran')); ?>",
                type: "GET",
                data: "id=" + id,
                dataType: 'json',
                success: function (data) {
        ...
        $("#btn-update-data").click(function (e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(URL('konfirmasi/update')); ?>",
                type: "PUT",
                data: sendData,
                dataType: 'json',
                beforeSend: function () {
                    ...
                    ok: {
                        ...
                        action: function () {
                            $.ajax({
                                ...
                                url: "<?php echo e(URL('konfirmasi/delete')); ?>",
                                type: "DELETE",
                                data: "id=" + id,
                                dataType: "json",
                                success: function (data) {
