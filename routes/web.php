...
Route::middleware(['checkRole'])->group(function () {
  ...
  Route::group(['prefix' => 'kehadiran'], function () {
    Route::get('/generate', 'KehadiranController@index');
    Route::get('/getKaryawan', 'KehadiranController@getKaryawan');
    Route::get('/cetak', 'KehadiranController@cetakDataKehadiran');
    Route::post('/json', 'KehadiranController@datatable');
    Route::post('/json1', 'KehadiranController@datatable1');
    Route::post('/json2', 'KehadiranController@datatable2');
    Route::post('/json3/{id}', 'KehadiranController@getTanggalKehadiranKaryawan');
    Route::post('/json4', 'KehadiranController@datatable3');
    Route::put('/changeKehadiran', 'KehadiranController@changeStatusKehadiran');
    Route::post('/generateKehadiran', 'KehadiranController@store');
    Route::get('/riwayat', 'KehadiranController@riwayatKehadiran');
    Route::get('/rekap', 'KehadiranController@rekapitulasiKehadiran');
  });
});
