														...
														<tr style="border-collapse:collapse;">
															<td class="es-m-txt-c" align="left"
																style="padding:0;Margin:0;"><h1
																	...
																	{{ $konfigurasi[4]->nilai_konfig }}<br></h1></td>
														</tr>
													</table>
												</td>
											</tr>
														...
														<tr style="border-collapse:collapse;">
															<td align="left"
																...
																<p style="text-align: center ;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;">
																	...
																	rekening {{ config('constants.NOREK') }} {{ config('constants.BANK') }} A.N. Failda
																	Waterpark sebesar {{ $total }} sebelum tanggal
																	{{ date('d-m-Y H:i', strtotime($batas)) }} WIB. Tiket
																	berlaku sampai dengan
																	tanggal {{ date("d-m-Y", strtotime("+7 days")) }}, lebih
																...
																<table
																	...
																	<tr style="border-collapse:collapse;">
																		...
																		<td style="padding:5px 0;Margin:0;" width="20%"
																			align="left"><p
																				style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																				{{ number_format($konfigurasi[2]->nilai_konfig, 0, ".", ".") }}
																				<br></p></td>
																	</tr>
																</table>
															</td>
														...
														<tr style="border-collapse:collapse;">
															<td align="left"
																style="padding:0;Margin:0;padding-bottom:10px;"><p
																	style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																	{{ $konfigurasi[0]->nilai_konfig }}</p></td>
														</tr>
													</table>
												</td>
											</tr>
													...
													<table width="100%" cellspacing="0" cellpadding="0"
														...
														<tr style="border-collapse:collapse;">
															<td align="left" style="padding:0;Margin:0;"><p
																	...
																	{{ $konfigurasi[6]->nilai_konfig }}</p></td>
														</tr>
													</table>
												</td>
											</tr>
														...
														<tr style="border-collapse:collapse;">
															<td class="es-m-txt-c" esdev-links-color="#777777"
																...
																style="padding:0;Margin:0;padding-bottom:5px;"><p
																	...
																	yaitu : &nbsp; {{ $konfigurasi[1]->nilai_konfig }}.<br>
																</p></td>
														</tr>
													</table>
												</td>
