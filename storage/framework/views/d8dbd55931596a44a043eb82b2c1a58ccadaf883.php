														...
														<tr style="border-collapse:collapse;">
															<td class="es-m-txt-c" align="left"
																style="padding:0;Margin:0;"><h1
																	...
																	<?php echo e($konfigurasi[4]->nilai_konfig); ?><br></h1></td>
														</tr>
													</table>
												</td>
											</tr>
																		...
																		<td valign="top" align="left"
																			...
																			<a href=""
																			   ...
																			   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;text-decoration:none;color:#FFFFFF;"><img
																					src="https://failda-waterpark.com/storage/img/77981522050090360.png"
																					alt=""
																					style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
																					width="27" height="23"></a></td>
																	</tr>
																</table>
															</td>
														</tr>
															...
															<td align="center"
																...
																<a target="_blank" href=""
																   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:16px;text-decoration:none;color:#ED8E20;">
																	<img
																		src="https://failda-waterpark.com/storage/img/67611522142640957.png"
																		alt=""
																		style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
														...
														<tr style="border-collapse:collapse;">
															<td class="es-m-txt-c" align="center"
																style="padding:0;Margin:0;padding-bottom:10px;"><strong><span
																		style="font-size:24px;">Te<span
																			style="background-color:#000000;"></span>rima kasih telah melakukan pemesanan</span></strong><br>
															</td>
														</tr>
														<tr style="border-collapse:collapse;">
															<td align="left"
																...
																<p style="text-align: center ;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;">
																	...
																	rekening <?php echo e(config('constants.NOREK')); ?> <?php echo e(config('constants.BANK')); ?> A.N. Failda
																	Waterpark sebesar <?php echo e($total); ?> sebelum tanggal
																	<?php echo e(date('d-m-Y H:i', strtotime($batas))); ?> WIB. Tiket
																	berlaku sampai dengan
																	tanggal <?php echo e(date("d-m-Y", strtotime("+7 days"))); ?>, lebih
																	dari itu tiket tidak bisa digunakan. Terima
																	kasih<br></p></td>
														</tr>
													</table>
												</td>
																...
																<table
																	...
																	<tr style="border-collapse:collapse;">
																		...
																		<td style="padding:5px 0;Margin:0;" width="20%"
																			align="left"><p
																				style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333; width: 118px;">
																				<?php echo e($data->kode_pemesanan); ?><br></p>
																		</td>
																	</tr>
																	<tr style="border-collapse:collapse;">
																		<td style="padding:5px 10px 5px 0;Margin:0;"
																			width="80%" align="left"><p
																				style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																				Tanggal Pemesanan</p></td>
																		<td style="padding:5px 0;Margin:0;" width="20%"
																			align="left"><p
																				style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																				<?php echo e($data->tgl_pemesanan); ?><br></p></td>
																	</tr>
																	<tr style="border-collapse:collapse;">
																		<td style="padding:5px 10px 5px 0;Margin:0;"
																			width="80%" align="left"><p
																		...
																		<td style="padding:5px 0;Margin:0;" width="20%"
																			align="left"><p
																				style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																				<?php echo e($data->jumlah_tiket); ?><br></p></td>
																	</tr>
																	<tr style="border-collapse:collapse;">
																		<td style="padding:5px 10px 5px 0;Margin:0;"
																			width="80%" align="left"><p
																		...
																		<td style="padding:5px 0;Margin:0;" width="20%"
																			align="left"><p
																				style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																				<?php echo e(number_format($konfigurasi[2]->nilai_konfig, 0, ".", ".")); ?>
																...
																<table
																	...
																	<tr style="border-collapse:collapse;">
																		<td width="80%" style="padding:0;Margin:0;"><h4
																				...
																				TOTAL</h4></td>
																		<td width="20%" style="padding:0;Margin:0;"><h4
																				style="width: 118px; Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;">
																				<?php echo e($total); ?></h4></td>
																	</tr>
																</table>
															</td>
														</tr>
														...
														<tr style="border-collapse:collapse;">
															<td align="left"
																style="padding:0;Margin:0;padding-bottom:15px;"><h4
																	style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;">
																	Alamat Perusahaan</h4></td>
														</tr>
														<tr style="border-collapse:collapse;">
															<td align="left"
																style="padding:0;Margin:0;padding-bottom:10px;"><p
																	style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;">
																	<?php echo e($konfigurasi[0]->nilai_konfig); ?></p></td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td width="255" align="left" style="padding:0;Margin:0;">
													<table width="100%" cellspacing="0" cellpadding="0"
														...
														<tr style="border-collapse:collapse;">
															<td align="left"
																style="padding:0;Margin:0;padding-bottom:15px;"><h4
																	style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif; float: right;">
																	Pimpinan Perusahaan<br></h4></td>
														</tr>
														<tr style="border-collapse:collapse;">
															<td align="left" style="padding:0;Margin:0;"><p
																	style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333; float: right;">
																	<?php echo e($konfigurasi[6]->nilai_konfig); ?></p></td>
														</tr>
													</table>
												</td>
											</tr>
														...
														<tr style="border-collapse:collapse;">
															<td align="center"
																style="padding:0;Margin:0;padding-top:25px;"><h2
																	...
																	Status Pembayaran Pemesanan Tiket.</h2></td>
														</tr>
														<tr style="border-collapse:collapse;">
															<td align="center"
														...
														<tr style="border-collapse:collapse;">
															<td class="es-m-txt-c" esdev-links-color="#777777"
																...
																style="padding:0;Margin:0;padding-bottom:5px;"><p
																	style="text-align: center;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#777777;">
																	Kritik dan saran bisa dilakukan melalui email kami
																	yaitu : &nbsp; <?php echo e($konfigurasi[1]->nilai_konfig); ?>.<br>
																</p></td>
														</tr>
													</table>
												</td>
