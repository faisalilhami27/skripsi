...
<head>
    ...
    <title>bodyEmailVerification</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        a {
...
<div class="es-wrapper-color" style="background-color:#EEEEEE;">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;"><h1
                                                        ...
                                                        {{ $konfigurasi[4]->nilai_konfig }}</h1></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" align="right"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            ...
                                                            <td valign="top" align="left"
                                                                style="padding:0;Margin:0;padding-left:10px;"><img
                                                                    src="https://failda-waterpark.com/storage/img/77981522050090360.png" alt=""
                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
                                                                    width="27" height="23"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
    ...
    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
        ...
        <tr style="border-collapse:collapse;">
            <td align="center" style="padding:0;Margin:0;">
                <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#F7F7F7"
                       align="center"
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td width="530" valign="top" align="center" style="padding:0;Margin:0;">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="center"
                                                    style="Margin:0;padding-top:20px;padding-bottom:25px;padding-left:35px;padding-right:35px;">
                                                    <a target="_blank" href=""
                                                       style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:15px;text-decoration:none;color:#ED8E20;">
                                                        <img
                                                            ...
                                                            alt="ship"
                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
                                                            title="ship" width="150" height="144"> </a></td>
                                            </tr>
                                            <tr style="border-collapse:collapse;">
                                                <td align="center" style="padding:0;Margin:0;padding-bottom:15px;"><h2
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td class="es-m-txt-l" align="left"
                                                    style="padding:0;Margin:0;padding-top:20px;"><h3
                                                        style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#333333;text-align:center;">
                                                        Hello {{ $nama }},</h3></td>
                                            </tr>
                                            <tr style="border-collapse:collapse;">
                                                <td align="left"
                                                    style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px;"><p
                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;text-align:center;">
                                                        Untuk menggunakan aplikasi mobile anda silahkan klik tombol
                                                        dibawah ini untuk menverifikasi email anda. Terima kasih.</p>
                                                </td>
                                            </tr>
                                            <tr style="border-collapse:collapse;">
                                                <td align="center"
													...
													<span class="es-button-border"
                                                          style="border-style:solid;border-color:transparent;background:none 0% 0% repeat scroll #ED8E20;border-width:0px;display:inline-block;border-radius:5px;width:auto;"> <a
                                                            href="{{ $token }}" class="es-button" target="_blank"
                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;color:#FFFFFF;border-style:solid;border-color:#ED8E20;border-width:15px 30px;display:inline-block;background:#ED8E20 none repeat scroll 0% 0%;border-radius:5px;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;">Verification</a> </span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
