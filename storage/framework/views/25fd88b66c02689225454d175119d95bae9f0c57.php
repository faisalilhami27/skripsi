    ...
    <div class="layout-content">
        <div class="layout-content-body">
            <div class="text-center m-b">
                <h3 class="m-b-0">Kelola Hak Akses Untuk <?php echo e($level->nama_level); ?></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div class="pull-left" style="margin-top: 20px"><a href="<?php echo e(URL('userlevel')); ?>" class="btn btn-danger btn-sm"><span class="icon icon-backward"></span> Kembali</a></div>
                                <div class="pull-right"><?php echo e($menu->links()); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            $(".change").each(function () {
                ...
                $(".create" + id).change(function () {
                    ...
                    var field = "create";
                    var level = '<?php echo e(Request::segment(3)); ?>';
                    $.ajax({
                        headers: {
                            'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
                        },
                        url: "<?php echo e(URL('userlevel/updateAccess')); ?>",
                        type: "PUT",
                        dataType: "json",
            ...
            $(".change").change(function () {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('userlevel/ubahprivilige')); ?>",
                    type: "POST",
                    dataType: "json",
